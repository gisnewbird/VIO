...
addpath('/home/dukeguo/imu_utils/src/kalibr_allan/matlab/functions/allan_v3')

% Our bag information
%mat_path = '../data/imu_mtig700.mat';
%mat_path = '../data/imu_tango.mat';
mat_path = '/home/dukeguo/imu_utils/src/kalibr_allan/data/imu.mat';
...
fprintf('saving to: %s\n',filename);
save(['/home/dukeguo/imu_utils/src/kalibr_allan/data/',filename],'update_rate','ts_imua','ts_imuw','tau','taumax','results_ax','results_ay','results_az','results_wx','results_wy','results_wz')
fprintf('done saving!\n');
